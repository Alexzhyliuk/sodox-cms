"""
Django settings for sodox project.
...
SECRET_KEY = 'django-insecure-=3milskoej7v_qmt8oe14#h!vj-n##tup42mphktx#3-j^zb%k'
...
WSGI_APPLICATION = 'sodox.wsgi.application'
